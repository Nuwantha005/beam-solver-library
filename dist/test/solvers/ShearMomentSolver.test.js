...
const ShearMomentSolver_1 = __importDefault(require("../../src/solvers/ShearMomentSolver"));
describe("ShearMomentSolver — Simply Supported Beam with Midspan Point Load", () => {
    ...
    beforeEach(() => {
        ...
        solver = new ShearMomentSolver_1.default(beam);
    });
...
describe("ShearMomentSolver — Simply Supported Beam with Full UDL", () => {
    ...
    beforeEach(() => {
        ...
        beam = new beam_1.Beam(8);
        beam.setSupports([new PinnedSupport_1.PinnedSupport(0), new RollerSupport_1.RollerSupport(8)]);
...
describe("ShearMomentSolver — Cantilever Beams", () => {
    it("should solve cantilever with tip load (L=5, P=12 at x=5, fixed at x=0)", () => {
        ...
        const solver = new ShearMomentSolver_1.default(beam);
...
describe("ShearMomentSolver — Triangular Distributed Load", () => {
    it("should find zero-crossing and maximum moment for triangular load", () => {
        ...
        beam.setSupports([new PinnedSupport_1.PinnedSupport(0), new RollerSupport_1.RollerSupport(6)]);
